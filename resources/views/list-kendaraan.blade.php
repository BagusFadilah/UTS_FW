...
<div class="container">
  <a class="btn btn-primary" href="/tambah-kendaraan"> Tambah</a>
</div><br>
<style>
    table {
...
<table class="table">
  <thead class="thead-dark">
    ...
    @endif
        ...
        <tr>
            <td>{{ $j->nomor_plat}}</td> 
            <td>{{ $j->merk_kendaraan}}</td> 
            <td>{{ $j->tipe_kendaraan}}</td>
            <td>
                <a class="btn btn-warning" href="/ubah-kendaraan/{{$j->id}}">Edit</a>
