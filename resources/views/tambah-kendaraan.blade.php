...
<form action="/simpan-kendaraan" method="POST" >
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="nomor_plat" id="nomor_plat">
    </div>
    <div class="form-group">
        <label for="merk_kendaraan">Merk Kendaraan : </label>
        <input class="form-control" type="text" name="merk_kendaraan" id="merk_kendaraan">
    </div>
    <div class="form-group">
        <label for="tipe_kendaraan">Tipe Kendaraan : </label>
        <input class="form-control" type="text" name="tipe_kendaraan" id="tipe_kendaraan">
    </div>
